...
{
    public static void main(String[] args)//运行出错，是定义的问题，部分int应该改成long
    {
        ...
        System.out.println(digitAtIndex(191)); //数字100的第一位：2
        System.out.println(digitAtIndex(192)); //数字100的第一位：3
        System.out.println(digitAtIndex(193)); //数字100的第一位：4
